 ...
 */
final class Version20240228153217 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event DROP artists');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD artists LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    }
}
